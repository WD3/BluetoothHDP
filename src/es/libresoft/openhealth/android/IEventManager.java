...
public class IEventManager implements InternalEventManager{
	...
	public void receivedMeasure(Agent agent, MeasureReporter mr) {
		...
		IMeasureDataDecoder iMeasureDataDecoder = new IMeasureDataDecoder();
		iMeasureDataDecoder.setMeasureReporter(mr);
		iMeasureDataDecoder.init();		
		iMeasureDataDecoder.receiveMeasures();		
	}
