...
public class PulseAgent extends Specialization{
	...
	public void addMeasure(int pulse, Date date){
		Measures.add(generateMeasure(pulse, date));
	}
	...
	private Map<HANDLE,Object> generateMeasure(int pulse, Date date){
